...
class Mixer6:
    def __init__(self, io_ports=32, delay_range=(1, 9)):
        ...
        self.wallets = [MixerWallet(balance=0.0, address=f"Mixer6 Wallet {i}") for i in range(1, io_ports+1)]
    ...
    def mix(self, amount, sender_wallet):
        ...
        print(f"Transferred {amount} from {sender_wallet.address} to {target_wallet.address} in Mixer 6")
